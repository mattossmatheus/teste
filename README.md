...
<p>Para instalar o agent, será necessario copiar o script **ynatrace-OneAgent-Linux*, e chave *dt-root.cert* para o host ou container que queria monitorar e executar o seguinte comando: </p>
